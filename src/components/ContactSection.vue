<template>
  <section class="text-white mt-20" id="contact">
    ...
    >
      <div>
        <p class="text-[#adb7be]">
            Silakan hubungi saya melalui salah satu opsi di bawah ini jika Anda memiliki pertanyaan atau ingin berdiskusi lebih lanjut. Saya siap membantu! 😊
        </p>
        <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
          <div class="flex mb-10 items-center">
            ...
            <div class="ml-5 text-white">
              <h4>Email</h4>
              <p>fikriakmalfauzan27@gmail.com</p>
            </div>
          </div>
          <div class="flex mb-10 items-center">
            <div
          ...
          <div class="flex mb-10 items-center">
            ...
            <div class="ml-5 text-white">
              <h4>LinkedIn</h4>
              <p>www.linkedin.com/in/fikri-akmal-fauzan-8083172a8</p>
            </div>
          </div>
          <div class="flex mb-10 items-center">
            <div
      ...
      >
        ...
        >
          <!-- <div class="mb-6">
                    <label for="email" class="text-white block mb-2 text-sm font-medium">WhatsApp</label>
                    <input type="email" id="email" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="+62 821-1642-3041" name="email">
                </div> -->
          <!-- <div class="mb-6">
...
export default {
  data() {
    return {
      message: "", // Data binding untuk textarea
    };
  },
  methods: {
    sendToWhatsApp() {
      const phoneNumber = "+6282116423041";
