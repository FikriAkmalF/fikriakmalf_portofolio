<template>
  <section class="relative w-full" data-aos="zoom-in-up">
    ...
    <div
      class="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-w-screen-xl mx-auto relative pt-32 pb-40"
    >
      ...
      >
        <div class="lg:py-6">
          <div class="text-center lg:text-left">
            <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
              ...
              >
                <br />Fikri Akmal Fauzan </span
              ><!-- 😁 -->
            </h1>
          </div>
          <p class="text-gray-300 pt-8 text-justify mx-auto max-w-xl">
            Saya adalah seorang Developer berpengalaman dalam pengembangan web sebagai
            Full Stack Developer. Saya menguasai framework Frontend seperti Vue JS atau
            React JS, dan mahir dalam framework Backend menggunakan Laravel. Saya mampu
            bekerja di seluruh stack pengembangan sesuai kebutuhan.
          </p>
          <div
          ...
          >
            ...
            >
              ...
              ></span>
              <a
                href="https://wa.me/6282116423041"
                target="_blank"
            ...
            >
              ...
              >
                ...
                <a
                  href="https://drive.google.com/file/d/11gSflsYGuGgRFkGWxXavQkGrXPL6eJnU/view?usp=drive_link"
                  target="_blank"
        ...
        <div class="lg:h-full md:flex">
          ...
          >
            ...
            >
              <img
                src="@/assets/foto_latar_merah_1.jpg"
                alt="Hero pic"
                width="500"
                height="auto"
                loading="lazy"
