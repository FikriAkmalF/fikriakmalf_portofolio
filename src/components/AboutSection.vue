    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8 text-justify">Saya adalah seorang Full Stack Developer dengan pengalaman 
                    dalam pengembangan web. Berpengalaman sebagai frontend dan backend. Saya telah mendapatkan sertifikasi dari Assyifa 
                    Islamic Philanthropy (AIP), Dinas Komunikasi dan Informatika, serta beberapa yang lainnya, 
                    yang menguatkan kompetensi saya dalam bidang pengembangan website.
                    Dengan kemampuan yang dimiliki dan semangat untuk terus belajar, saya berkomitmen untuk 
                    menciptakan solusi yang inovatif, efektif, dan sesuai dengan kebutuhan pengguna. Saya 
                    juga terbiasa bekerja secara tim maupun individu.
                </p>
