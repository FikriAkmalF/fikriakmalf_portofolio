    ...
    >
      ...
      >
        ...
        <p class="text-base lg:text-lg mt-8 py-8 text-justify">
          Sebagai Full Stack Developer, saya memiliki minat kuat terhadap
          teknologi frontend dan backend. Saya berspesialisasi dalam React.js
          dan pengembangan backend, dengan berpengalaman integrasi Artificial
          Intelligence (AI) dengan API serta membangun komponen yang dinamis dan
          efisien dan saya terus mempelajari teknologi baru serta mengembangkan
          diri untuk menciptakan web yang berdampak dan berpusat pada pengguna
          (user-centered).
        </p>
