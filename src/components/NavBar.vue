<template>
    <header class="fixed top-0 left-0 right-0 w-full flex justify-between items-center p-6 bg-[#111827]/60 z-50">
    <!-- <header class="fixed top-0 left-0 right-0 w-full flex justify-between items-center p-6 bg-[#111827] z-20"> -->
        <div class="text-white text-3xl font-bold">Full Stack Developer</div>
